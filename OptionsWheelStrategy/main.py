...
class WheelStrategyAlgorithm(QCAlgorithm):
    ...
    def initialize(self):
        self.set_start_date(2021, 10, 19)
    ...
    def on_data(self, data):
        if not self.portfolio.invested and self.is_market_open(self._equity.symbol):
            # Either this is the very beginning of the algo, or the last call was exercised meaning I don't own any shares
            ...
            # The last put was exercised, meaning I now own shares
            # Sell a call for same number of shares
